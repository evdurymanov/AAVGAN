...
flags.DEFINE_string('dataset', DATASET+ "/testing_cgan_up_150",
...
flags.DEFINE_integer('steps', 1000, 'Number of steps to train')
...
if MODEL_TYPE == 'sngan':
    ...
    flags.DEFINE_integer('gf_dim', 44, 'Dimensionality of gf. [64]')
    flags.DEFINE_integer('df_dim', 30, 'Dimensionality of df. [64]')
    flags.DEFINE_string('loss_type', 'non_saturating',
                        'the loss type can be [wgan-gp, hinge_loss, hinge_loss_ra, wasserstein or kl_loss, ipot, non_saturating]')
    flags.DEFINE_string('architecture', 'gumbel', 'Network architecture. Options: [gumbel, resnet]')
